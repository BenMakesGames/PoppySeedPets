...
final class Version20260728023546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        -- the item itself!
        INSERT INTO item (`id`, `name`, `description`, `image`, `use_actions`, `tool_id`, `food_id`, `fertilizer`, `plant_id`, `hat_id`, `fuel`, `recycle_value`, `enchants_id`, `spice_id`, `treasure_id`, `is_bug`, `hollow_earth_tile_card_id`, `cannot_be_thrown_out`, `museum_points`) VALUES (1527,"Raven\'s Beak",NULL,"tool/spear/ravens-beak",NULL,538,NULL,0,NULL,NULL,300,10,160,NULL,NULL,0,NULL,0,2) ON DUPLICATE KEY UPDATE `id` = `id`;
